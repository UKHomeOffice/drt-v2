...
function (_BaseMap) {
  ...
  function ValueMap() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ValueMap).apply(this, arguments));
  }
  ...
  _createClass(ValueMap, [{
    ...
    value: function insert(insertionIndex, insertedIndexes) {
      this.list = (0, _physicallyIndexed.getListWithInsertedItems)(this.list, insertionIndex, insertedIndexes, this.initValueOrFn);

      _get(_getPrototypeOf(ValueMap.prototype), "insert", this).call(this, insertionIndex, insertedIndexes);
    }
    /**
    ...
    value: function remove(removedIndexes) {
      ...
      _get(_getPrototypeOf(ValueMap.prototype), "remove", this).call(this, removedIndexes);
    }
  }]);
