...
var _actionsOnIndexes = require("../../../translations/maps/utils/actionsOnIndexes");
...
/*#__PURE__*/
function (_BaseMap) {
  _inherits(LooseBindsMap, _BaseMap);
  ...
  _createClass(LooseBindsMap, [{
    ...
    value: function remove(removedIndexes) {
      var listAfterUpdate = (0, _physicallyIndexed.getListWithRemovedItems)(this.list, removedIndexes);
