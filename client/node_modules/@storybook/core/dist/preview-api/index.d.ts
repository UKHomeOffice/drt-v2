...
declare class StoryStore<TRenderer extends Renderer> {
    ...
    getStoryContext(story: PreparedStory<TRenderer>, { forceInitialArgs }?: {
        ...
        applyAfterEach: (context: StoryContext<TRenderer, _storybook_csf.Args>) => Promise<void>;
...
declare const filterArgTypes: (argTypes: StrictArgTypes, include?: PropDescriptor, exclude?: PropDescriptor) => Partial<StrictArgTypes<_storybook_csf.Args>>;
...
declare class DocsContext<TRenderer extends Renderer> implements DocsContextProps<TRenderer> {
    ...
    getStoryContext: (story: PreparedStory<TRenderer>) => {
        ...
        applyAfterEach: (context: _storybook_csf.StoryContext<TRenderer, _storybook_csf.Args>) => Promise<void>;
...
declare class Preview<TRenderer extends Renderer> {
    ...
    getStoryContext(story: PreparedStory<TRenderer>, { forceInitialArgs }?: {
        ...
        applyAfterEach: (context: _storybook_csf.StoryContext<TRenderer, Args>) => Promise<void>;
