...
var We = Object.getPrototypeOf, Me = Object.prototype.hasOwnProperty;
var u = (s, e) => W(s, "name", { value: e, configurable: !0 });
var _ = (s, e) => () => (e || s((e = { exports: {} }).exports, e), e.exports);
var Le = (s, e, t, i) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let n of je(e))
      !Me.call(s, n) && n !== t && W(s, n, { get: () => e[n], enumerable: !(i = qe(e, n)) || i.enumerable });
  return s;
};
var S = (s, e, t) => (t = s != null ? Be(We(s)) : {}, Le(
  // If the importer is in node compatibility mode or this is not an ESM
  // file that has been converted to a CommonJS file using a Babel-
  // compatible transform (i.e. "__esModule" has not been set), then set
  // "default" to the CommonJS "module.exports" for node compatibility.
  e || !s || !s.__esModule ? W(t, "default", { value: s, enumerable: !0 }) : t,
  s
));
...
var A = _((L) => {
  ...
  L.CommanderError = $;
  L.InvalidArgumentError = M;
});

// ../node_modules/commander/lib/argument.js
var V = _((G) => {
  var { InvalidArgumentError: Re } = A(), R = class {
    static {
      u(this, "Argument");
    }
    /**
  ...
  u(Ge, "humanReadableArgName");
  G.Argument = R;
  G.humanReadableArgName = Ge;
});

// ../node_modules/commander/lib/help.js
var J = _((ce) => {
  var { humanReadableArgName: Ue } = V(), U = class {
    static {
      u(this, "Help");
    }
    constructor() {
     ...
     */
    subcommandTerm(e) {
      let t = e.registeredArguments.map((i) => Ue(i)).join(" ");
...
`).replace(/^/gm, " ".repeat(r));
      ...
      let O = t.visibleCommands(e).map((f) => l(
        t.subcommandTerm(f),
        t.subcommandDescription(f)
      ));
      return O.length > 0 && (h = h.concat(["Commands:", a(O), ""])), h.join(`
`);
    }
    /**
...
`, `
`), c = " ".repeat(i), d = "\\s\u200B", O = new RegExp(
        `
|.{1,${l - 1}}([${d}]|$)|[^${d}]+?([${d}]|$)`,
        "g"
      ), f = h.match(O) || [];
      return a + f.map((x, j) => x === `
` ? "" : (j > 0 ? c : "") + x.trimEnd()).join(`
`);
    }
  };
  ce.Help = U;
...
var Q = _((z) => {
  var { InvalidArgumentError: Je } = A(), Y = class {
    static {
      u(this, "Option");
    }
    /**
     ...
     */
    attributeName() {
      return Ye(this.name().replace(/^no-/, ""));
    }
    /**
...
(Did you mean ${i[0]}?)` : "";
  ...
  u(Qe, "suggestSimilar");
  me.suggestSimilar = Qe;
});

// ../node_modules/commander/lib/command.js
var be = _((_e) => {
  var Xe = require("node:events").EventEmitter, X = require("node:child_process"), C = require("node:path"), Z = require("node:fs"), p = require("node:process"),
  { Argument: Ze, humanReadableArgName: et } = V(), { CommanderError: ee } = A(), { Help: tt } = J(), { Option: de, DualOptions: it } = Q(),
  { suggestSimilar: fe } = pe(), te = class s extends Xe {
    static {
      u(this, "Command");
    }
    /**
     ...
     */
    createHelp() {
      return Object.assign(new tt(), this.configureHelp());
    }
    /**
...
Expecting one of '${i.join("', '")}'`);
     ...
     */
    _exit(e, t, i) {
      this._exitCallback && this._exitCallback(new ee(e, t, i)), p.exit(e);
    }
    /**
...
-  already used by option '${t.flags}'`);
     ...
     */
    _optionEx(e, t, i, n, r) {
      if (typeof t == "object" && t instanceof de)
        throw new Error(
    ...
    _executeSubCommand(e, t) {
      ...
      if (this._scriptPath) {
        let c;
        try {
          c = Z.realpathSync(this._scriptPath);
        } catch {
          c = this._scriptPath;
        }
        l = C.resolve(
      ...
      let a;
      p.platform !== "win32" ? i ? (t.unshift(o), t = ge(p.execArgv).concat(t), a = X.spawn(p.argv[0], t, { stdio: "inherit" })) : a = X.spawn(
      o, t, { stdio: "inherit" }) : (t.unshift(o), t = ge(p.execArgv).concat(t), a = X.spawn(p.execPath, t, { stdio: "inherit" })), a.killed ||
...
`), this.outputHelp({ error: !0 }));
    ...
    _parseOptionsImplied() {
      let e = new it(this.options), t = /* @__PURE__ */ u((i) => this.getOptionValue(i) !== void 0 && !["default", "implied"].includes(this.
...
`), this._exit(0, "commander.version", e);
    ...
    usage(e) {
      if (e === void 0) {
        ...
        let t = this.registeredArguments.map((i) => et(i));
        return [].concat(
...
`);
  ...
  u(ge, "incrementNodeInspectorPort");
  _e.Command = te;
});

// ../node_modules/commander/index.js
var we = _((g) => {
  var { Argument: Oe } = V(), { Command: ie } = be(), { CommanderError: nt, InvalidArgumentError: Ce } = A(), { Help: rt } = J(), { Option: xe } = Q();
  g.program = new ie();
  g.createCommand = (s) => new ie(s);
  g.createOption = (s, e) => new xe(s, e);
  g.createArgument = (s, e) => new Oe(s, e);
  g.Command = ie;
  g.Option = xe;
  g.Argument = Oe;
  g.Help = rt;
  g.CommanderError = nt;
  g.InvalidArgumentError = Ce;
  g.InvalidOptionArgumentError = Ce;
});
...
var ve = _((H) => {
  ...
  H.walkUp = void 0;
  var ye = require("path"), st = /* @__PURE__ */ u(function* (s) {
    for (s = (0, ye.resolve)(s); s; ) {
      yield s;
      let e = (0, ye.dirname)(s);
      if (e === s)
        break;
      s = e;
    }
...
var $e = _((Tt, ae) => {
  var ke = process.argv || [], T = process.env, ht = !("NO_COLOR" in T || ke.includes("--no-color")) && ("FORCE_COLOR" in T || ke.includes("\
--color") || process.platform === "win32" || require != null && require("tty").isatty(1) && T.TERM !== "dumb" || "CI" in T), ct = /* @__PURE__ */ u(
  (s, e, t = s) => (i) => {
    let n = "" + i, r = n.indexOf(e, s.length);
    return ~r ? s + mt(n, e, t, r) + e : s + n + e;
  }, "formatter"), mt = /* @__PURE__ */ u((s, e, t, i) => {
    let n = "", r = 0;
    do
      n += s.substring(r, i) + t, r = i + e.length, i = s.indexOf(e, r);
    while (~i);
    return n + s.substring(r);
  }, "replaceClose"), Se = /* @__PURE__ */ u((s = ht) => {
    let e = s ? ct : () => String;
    return {
      isColorSupported: s,
...
var y = require("@storybook/core/common"), Ie = require("@storybook/core/telemetry"), he = require("@storybook/core/node-logger"), k = S(we(), 1);

// ../node_modules/fd-package-json/dist/esm/main.js
var ne = S(ve(), 1), re = require("node:path"), P = require("node:fs/promises"), D = require("node:fs");
async function ot(s) {
  try {
...
u(at, "fileExistsSync");
async function lt(s) {
  for (let e of (0, ne.walkUp)(s)) {
    let t = (0, re.resolve)(e, "package.json");
    if (await ot(t))
      return t;
  }
  return null;
}
u(lt, "findPackagePath");
async function N(s) {
  let e = await lt(s);
  if (!e)
    return null;
...
u(ut, "findPackagePathSync");
function Ae(s) {
  let e = ut(s);
  if (!e)
    return null;
  try {
    let t = (0, D.readFileSync)(e, { encoding: "utf8" });
    return JSON.parse(t);
  } catch {
    return null;
  }
}
u(Ae, "findPackageSync");
...
function oe(s, e) {
  ...
  let o, l, a, h, c = 0, m = 0;
  for (; c < i; )
    Ee[c] = s.charCodeAt(r + c), se[c] = ++c;
  for (; m < n; )
    for (o = e.charCodeAt(r + m), a = m++, l = m, c = 0; c < i; c++)
      h = o === Ee[c] ? a : a + 1, a = se[c], l = se[c] = a > l ? h > l ? l + 1 : h : h > a ? a + 1 : h;
  return l;
}
u(oe, "leven");
...
var pt = process.env.NODE_ENV === "production", le = "Invariant failed";
function v(s, e) {
  if (!s) {
    if (pt)
      throw new Error(le);
    var t = typeof e == "function" ? e() : e, i = t ? "".concat(le, ": ").concat(t) : le;
    throw new Error(i);
  }
}
u(v, "invariant");
...
// src/cli/build.ts
var Ve = require("@storybook/core/common"), I = require("@storybook/core/core-server");
var He = /* @__PURE__ */ u(async (s) => {
  let e = await N(__dirname);
  ...
  await (0, I.withTelemetry)(
    "build",
    { cliOptions: s, presetOptions: t },
    () => (0, I.buildStaticStandalone)(t)
  );
}, "build");

// src/cli/dev.ts
var Ne = require("@storybook/core/common"), F = require("@storybook/core/core-server"), b = require("@storybook/core/node-logger");
var ue = S(De(), 1);
function dt(s) {
  b.instance.heading = "", s instanceof Error ? s.error ? b.logger.error(s.error) : s.stats && s.stats.compilation.errors ? s.stats.compilation.
  errors.forEach((e) => b.logger.plain(e)) : b.logger.error(s) : s.compilation?.errors && s.compilation.errors.forEach((e) => b.logger.plain(
  e)), b.logger.line(), b.logger.warn(
    s.close ? ue.dedent`
...
var Te = /* @__PURE__ */ u(async (s) => {
  ...
  await (0, F.withTelemetry)(
    ...
    () => (0, F.buildDevStandalone)(t)
  );
}, "dev");

// src/cli/bin/index.ts
(0, Ie.addToGlobalContext)("cliVersion", y.versions.storybook);
var w = Ae(__dirname);
v(w, "Failed to find the closest package.json file.");
var q = console, Fe = /* @__PURE__ */ u((s) => k.program.command(s).option(
  "--disable-telemetry",
...
command");
Fe("dev").option("-p, --port <number>", "Port to run Storybook", (s) => parseInt(s, 10)).option("-h, --host <string>", "Host to run Storyboo\
...
ly site using addon-docs").option("--exact-port", "Exit early if the desired port is not available").option(
  ...
  he.logger.setLevel(s.loglevel), q.log(B.default.bold(`${w.name} v${w.version}`) + B.default.reset(`
`)), (0, y.getEnvConfig)(s, {
    port: "SBCONFIG_PORT",
    ...
    ci: "CI"
  }), parseInt(`${s.port}`, 10) && (s.port = parseInt(`${s.port}`, 10)), await Te({ ...s, packageJson: w }).catch(() => process.exit(1));
});
Fe("build").option("-o, --output-dir <dir-name>", "Directory where to store built files").option("-c, --config-dir <dir-name>", "Directory w\
...
ly site using addon-docs").option("--test", "Build stories optimized for testing purposes.").action(async (s) => {
  process.env.NODE_ENV = process.env.NODE_ENV || "production", he.logger.setLevel(s.loglevel), q.log(B.default.bold(`${w.name} v${w.version}\
...
k.program.on("command:*", ([s]) => {
 ...
 See --help for a list of available commands.`,
  ...
  let t = k.program.commands.map((i) => i.name()).find((i) => oe(i, s) < 3);
  t && q.info(`
