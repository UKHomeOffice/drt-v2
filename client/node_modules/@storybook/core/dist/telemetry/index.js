...
:", Gr = Ar(), _r = /* @__PURE__ */ o((e) => Object.assign(new Error(`not found: ${e}`), { code: "ENOENT" }), "getNotFoundError"), jr = /* @__PURE__ */ o(
  (e, t) => {
    ...
    let { pathEnv: n, pathExt: i, pathExtExe: s } = jr(e, t), a = [], c = /* @__PURE__ */ o((l) => new Promise((f, x) => {
      if (l === n.length)
        return t.all && a.length ? f(a) : x(_r(e));
...
var Sn = p((U) => {
  ...
  var Rs = y("os"), xn = bn(), Gs = pt(), _s = /* @__PURE__ */ o(function() {
  ...
  }, "getSignalByName"), Ns = _s();
  U.signalsByName = Ns;
  var Bs = /* @__PURE__ */ o(function() {
    let e = (0, xn.getSignals)(), t = Gs.SIGRTMAX + 1, r = Array.from({ length: t }, (n, i) => Ds(i, e));
...
var An = p((Nf, W) => {
  var w = global.process, G = /* @__PURE__ */ o(function(e) {
...
tion" && typeof e.listeners == "function" && typeof e.kill == "function" && typeof e.pid == "number" && typeof e.on == "function";
  ...
  G(w) ? (kn = y("assert"), $ = Tn(), In = /^win/i.test(w.platform), X = y("events"), typeof X != "function" && (X = X.EventEmitter), w.__signal_exit_emitter__ ?
  ...
  P.infinite = !0), W.exports = function(e, t) {
    ...
    !q || !G(global.process) || (q = !1, $.forEach(function(t) {
      try {
        w.removeListener(t, xe[t]);
      } catch {
      }
    }), w.emit = Se, w.reallyExit = ht, P.count -= 1);
  }, "unload"), W.exports.unload = be, _ = /* @__PURE__ */ o(function(t, r, n) {
    P.emitted[t] || (P.emitted[t] = !0, P.emit(t, r, n));
  }, "emit"), xe = {}, $.forEach(function(e) {
    xe[e] = /* @__PURE__ */ o(function() {
      if (G(global.process)) {
        var r = w.listeners(e);
        r.length === P.count && (be(), _("exit", null, e), _("afterexit", null, e), In && e === "SIGHUP" && (e = "SIGINT"), w.kill(w.pid, e));
      }
    }, "listener");
  }), W.exports.signals = function() {
    return $;
  }, q = !1, mt = /* @__PURE__ */ o(function() {
    q || !G(global.process) || (q = !0, P.count += 1, $ = $.filter(function(t) {
      try {
    ...
    G(global.process) && (w.exitCode = t || /* istanbul ignore next */
    0, _("exit", w.exitCode, null), _("afterexit", w.exitCode, null), ht.call(w, w.exitCode));
    ...
    if (t === "exit" && G(global.process)) {
      ...
      return _("exit", w.exitCode, null), _("afterexit", w.exitCode, null), n;
    } else
  ...
  var kn, $, In, X, P, be, _, xe, q, mt, ht, Cn, Se, On;
});
...
var eo = p((Zf, H) => {
  "use strict";
  var ka = y("path"), St = y("child_process"), Ia = lt(), Ca = an(), Oa = ln(), Aa = mn(), ve = vn(), Kn = En(), { spawnedKill: Ra, spawnedCancel: Ga,
  setupTimeout: _a, validateTimeout: ja, setExitHandler: Na } = Gn(), { handleInput: Ba, getSpawnedResult: Da, makeAllStream: Ma, validateInputSync: La } = $n(),
  ...
  Ca(t) : t, "handleOutput"), Pe = /* @__PURE__ */ o((e, t, r) => {
    ...
    let c = Fa(a), u = _a(a, n.options, c), l = Na(a, n.options, u), f = { isCanceled: !1 };
    a.kill = Ra.bind(null, a.kill.bind(a)), a.cancel = Ga.bind(null, a, f);
...
var ii = p((Om, oi) => {
  "use strict";
  var { sep: Ru } = y("path"), Gu = /* @__PURE__ */ o((e) => {
    for (let t of e) {
      let r = /(\/|\\)/.exec(t);
  ...
  oi.exports = /* @__PURE__ */ o(function(t, r = Gu(t)) {
    let [n = "", ...i] = t;
...
}), "signalExitWrap"), Rt = class extends _e {
  static {
...
var Ac = 1e3 * 5, xo = /* @__PURE__ */ o((e, t = "SIGTERM", r = {}) => {
  ...
  s.unref && s.unref();
}, "setKillTimeout"), Gc = /* @__PURE__ */ o((e, { forceKillAfterTimeout: t }, r) => _c(e) && t !== !1 && r, "shouldForceKill"), _c = /* @__PURE__ */ o(
...
async function Me(e, t) {
  ...
  try {
    return _o(await Lt(e, t));
  } catch (r) {
    throw r.bufferedData !== void 0 && (r.bufferedData = _o(r.bufferedData)), r;
  }
}
o(Me, "getStreamAsBuffer");
var _o = /* @__PURE__ */ o((e) => globalThis.Buffer.from(e), "arrayBufferToNodeBuffer");
...
function mi(e, t = "default") {
  ...
  return r ||= di(process.cwd(), ".cache", "storybook"), di(r, t, e);
}
...
}, "upgradeFields"), kl = ["init", "upgrade"], Il = ["build", "dev", "error"], _i = /* @__PURE__ */ o((e, t) => {
  let r = t.map((n) => e?.[n]).filter(Boolean).sort((n, i) => i.timestamp - n.timestamp);
  return r.length > 0 ? r[0] : void 0;
}, "lastEvent"), Cl = /* @__PURE__ */ o(async (e = void 0) => {
  let t = e || await ar.get("lastEvents") || {}, r = _i(t, kl), n = _i(t, Il);
  if (r)
...
// src/telemetry/telemetry.ts
var Al = (0, Mi.default)(Ni), Rl = process.env.STORYBOOK_TELEMETRY_URL || "https://storybook.js.org/event-log", Ye = [], Gl = /* @__PURE__ */ o(
(e, t) => {
  ur[e] = t;
}, "addToGlobalContext"), _l = /* @__PURE__ */ o(() => {
  try {
    let e = Di.platform();
...
sExampleStoryId"), Ug = /* @__PURE__ */ o(async (e, t = {}, r = {}) => {
  e !== "boot" && await hr();
  let n = {
    eventType: e,
    payload: t
