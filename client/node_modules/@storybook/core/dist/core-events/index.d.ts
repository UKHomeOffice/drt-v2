...
type TestProviderState<Details extends {
    ...
    [key: string]: any;
} = NonNullable<unknown>> = Addon_TestProviderState<Details, Config>;
type TestProviders = Record<TestProviderId, TestProviderConfig & TestProviderState>;
type TestingModuleRunRequestPayload<Config extends {
    [key: string]: any;
} = NonNullable<unknown>> = {
...
type TestingModuleWatchModeRequestPayload<Config extends {
    [key: string]: any;
} = NonNullable<unknown>> = {
    providerId: TestProviderId;
    watchMode: boolean;
...
type TestingModuleConfigChangePayload<Config extends {
    [key: string]: any;
} = NonNullable<unknown>> = {
    providerId: TestProviderId;
    config: Config;
