...
object TerminalDeploymentTests extends TestSuite  {
  ...
  def tests = TestSuite {
    ...
    "Given crunch results and simulation results for 16 minutes in 1 queue, when we ask for TerminalDeploymentsRows " +
      ...
      val expected = Seq(
        TerminalDeploymentsRow(0L, List(QueueDeploymentsRow(0L, pax = 75, crunchDeskRec = 7, userDeskRec = DeskRecTimeslot(0, 0), waitTimeWithCrunchDeskRec = 8, waitTimeWithUserDeskRec = 15, "eeaDesk"))),
        TerminalDeploymentsRow(15L * 60000, List(QueueDeploymentsRow(15L * 60000, pax = 5, crunchDeskRec = 3, userDeskRec = DeskRecTimeslot(15L * 60000, 0), waitTimeWithCrunchDeskRec = 4, waitTimeWithUserDeskRec = 9, "eeaDesk")))
      )
    ...
    "Given crunch results and simulation results for 32 minutes in 1 queue, when we ask for TerminalDeploymentsRows " +
      ...
      val expected = Seq(
        TerminalDeploymentsRow(0L, List(QueueDeploymentsRow(0L, pax = 71, crunchDeskRec = 7, userDeskRec = DeskRecTimeslot(0, 0), waitTimeWithCrunchDeskRec = 8, waitTimeWithUserDeskRec = 15, "eeaDesk"))),
        TerminalDeploymentsRow(15L * 60000, List(QueueDeploymentsRow(15L * 60000, pax = 76, crunchDeskRec = 9, userDeskRec = DeskRecTimeslot(15L * 60000, 0), waitTimeWithCrunchDeskRec = 9, waitTimeWithUserDeskRec = 14, "eeaDesk"))),
        TerminalDeploymentsRow(30L * 60000, List(QueueDeploymentsRow(30L * 60000, pax = 12, crunchDeskRec = 3, userDeskRec = DeskRecTimeslot(30L * 60000, 0), waitTimeWithCrunchDeskRec = 4, waitTimeWithUserDeskRec = 9, "eeaDesk")))
      )
