...
object StaffingComponentTimezoneTests extends TestSuite {
  ...
  def tests: Tests = Tests {
    val utcToBSTChangeDate = SDate("2019-03-31")
        ...
        test("When inputting data to the monthly staffing table and the timezone changes from UTC to BST") - {
          test("Given 2019-03-31 (timezone change day) I should get back a list of 23 hours of time slots not the usual 24") - {
          ...
          test("Given 2019-03-30  (regular UTC day) I should get back a list of 24 hours of time slots") - {
          ...
          test("Given I pass timezone change day time slots into the time zone day slots method then I should get back " +
          ...
          test("Given I pass 2019-03-31 change day time slots into the time zone day slots method then the last time slot" +
          ...
          test("Given 2019-01-01 when retrieving days in month by time slot with 1 hour slots I should get back a 24x31 matrix") - {
          ...
          test("Given 2019-01-01 when retrieving days in week by time slot with 1 hour slots I should get back a 24x6 matrix") - {
          ...
          test("Given 2019-01-01 when retrieving days in day by time slot with 1 hour slots I should get back a 24x1 matrix") - {
            val startDate = SDate("2019-01-05")
          ...
          test("Given 2019-01-01 when retrieving days in month by time slot with 1 hour slots row 1 should be midnight for " +
          ...
          test("Given 2019-03-01 the final day in row 2 should be None (handling switch to BST)") - {
          ...
          test("When handling user changes to the monthly staffing table and the timezone changes from UTC to BST") - {

            test("Given 1 staff member is entered for 2019-03-31T00:00:00Z I should get an updated StaffAssignment for that" +
              " 15 minute slot") - {
            ...
            test("Given 1 staff member is entered for 2019-03-30T01:00:00Z I should get an updated StaffAssignment for that" +
              " 1 hour slot") - {
            ...
            test("Given 1 staff member is entered for 2019-03-31T01:00:00Z (timezone swtich time) I should get an updated " +
    ...
    test("When inputing data to the monthly staffing table and the timezone changes from BST to UTC") - {
      val bstToUtcChangeDate = SDate("2019-10-27")
            test("Given 2019-10-27 (timezone change day) I should get back a list of 25 hours of time slots not the usual 24") - {
      ...
      test("Given I pass timezone change day time slots into the time zone day slots method then I should get back no empty slots") - {

        val changeDayTimeslots: Seq[SDateLike] = slotsInDay(bstToUtcChangeDate, 15)

        val result = timeZoneSafeTimeSlots(changeDayTimeslots, 15).take(16)
          .collect {
            case Some(sd) => sd.millisSinceEpoch
          }

        val expected = Seq(
          SDate("2019-10-26T23:00:00Z"),
          SDate("2019-10-26T23:15:00Z"),
          SDate("2019-10-26T23:30:00Z"),
          SDate("2019-10-26T23:45:00Z"),
          SDate("2019-10-27T00:00:00Z"),
          SDate("2019-10-27T00:15:00Z"),
          SDate("2019-10-27T00:30:00Z"),
          SDate("2019-10-27T00:45:00Z"),
          SDate("2019-10-27T01:00:00Z"),
          SDate("2019-10-27T01:15:00Z"),
          SDate("2019-10-27T01:30:00Z"),
          SDate("2019-10-27T01:45:00Z"),
          SDate("2019-10-27T02:00:00Z"),
          SDate("2019-10-27T02:15:00Z"),
          SDate("2019-10-27T02:30:00Z"),
          SDate("2019-10-27T02:45:00Z"),
        ).map(_.millisSinceEpoch)

        assert(result == expected)
      }

      test("Given I pass timezone another October day time slots into the time zone day slots method then I should " +
