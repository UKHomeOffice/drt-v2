    ...
    "Staff Movements" - {
      ...
      "should not display pairs of movements that lie completely outside of the day provided" - {
        ...
        val pairYesterday = Seq(
          StaffMovement("T1", "reason start", SDate("2017-07-21T10:00"), 1, uidYesterday, None, None),
          StaffMovement("T1", "reason end", SDate("2017-07-21T12:00"), 1, uidYesterday, None, None))
        val pairToday = Seq(
          StaffMovement("T1", "reason start", SDate("2017-07-22T10:00"), 1, uidToday, None, None),
          StaffMovement("T1", "reason end", SDate("2017-07-22T12:00"), 1, uidToday, None, None))
        val pairTomorrow = Seq(
          StaffMovement("T1", "reason start", SDate("2017-07-23T10:00"), 1, uidTomorrow, None, None),
          StaffMovement("T1", "reason end", SDate("2017-07-23T12:00"), 1, uidTomorrow, None, None))
