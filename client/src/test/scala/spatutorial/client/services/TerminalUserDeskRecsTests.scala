...
object TerminalUserDeskRecsTests extends TestSuite {
  ...
  def tests = TestSuite {
    ...
    "Given crunch results and simulation results for 32 minutes in 1 queue, when we ask for TerminalUserDeskRecsRows " +
      ...
      val expected = Seq(
        TerminalUserDeskRecsRow(0L, Seq(QueueDetailsRow(crunchDeskRec = 7, userDeskRec = DeskRecTimeslot("0", 11), waitTimeWithCrunchDeskRec = 8, waitTimeWithUserDeskRec = 15))),
        TerminalUserDeskRecsRow(15L, Seq(QueueDetailsRow(crunchDeskRec = 9, userDeskRec = DeskRecTimeslot("15", 11), waitTimeWithCrunchDeskRec = 9, waitTimeWithUserDeskRec = 14))),
        TerminalUserDeskRecsRow(30L, Seq(QueueDetailsRow(crunchDeskRec = 3, userDeskRec = DeskRecTimeslot("30", 5), waitTimeWithCrunchDeskRec = 4, waitTimeWithUserDeskRec = 9)))
      )
    ...
    "Given crunch results and simulation results for 16 minutes in 2 queues, when we ask for TerminalUserDeskRecsRows " +
      ...
      val expected = Seq(
        TerminalUserDeskRecsRow(0L, Seq(
          QueueDetailsRow(crunchDeskRec = 7, userDeskRec = DeskRecTimeslot("0", 11), waitTimeWithCrunchDeskRec = 8, waitTimeWithUserDeskRec = 15),
          QueueDetailsRow(crunchDeskRec = 8, userDeskRec = DeskRecTimeslot("0", 12), waitTimeWithCrunchDeskRec = 9, waitTimeWithUserDeskRec = 16))),
        TerminalUserDeskRecsRow(15L, Seq(
          QueueDetailsRow(crunchDeskRec = 3, userDeskRec = DeskRecTimeslot("15", 5), waitTimeWithCrunchDeskRec = 4, waitTimeWithUserDeskRec = 9),
          QueueDetailsRow(crunchDeskRec = 4, userDeskRec = DeskRecTimeslot("15", 5), waitTimeWithCrunchDeskRec = 5, waitTimeWithUserDeskRec = 10)
        ))
      )
