...
import spatutorial.client.services.ChangeDeskUsage
...
//        , deskSimulationInputs(labels, potCrunchResult, dispatch)
  ...
  def deskSimulationInputs(labels: IndexedSeq[String], potCrunchResult: Pot[SimulationResult], dispatch: Action => Callback): ReactNode = {
