...
case class RootModel(applicationVersion: Pot[ClientServerVersions] = Empty,
                     ...
                     dayOfStaffShifts: Pot[ShiftAssignments] = Empty,
                     allShifts: Pot[ShiftAssignments] = Empty,
                     allStaffShifts:Pot[ShiftAssignments] = Empty,
                     ...
                     staffShifts: Pot[Seq[StaffShift]] = Empty,
...
trait DrtCircuit extends Circuit[RootModel] with ReactConnector[RootModel] {
  ...
  override val actionHandler: HandlerFunction = {
    val composedHandlers: HandlerFunction = composeHandlers(
      ...
      new StaffShiftsHandler(currentViewMode, zoomRW(_.dayOfStaffShifts)((m, v) => m.copy(dayOfStaffShifts = v))),
      new AllShiftsHandler(zoomRW(_.allShifts)((m, v) => m.copy(allShifts = v))),
      new AllStaffShiftsHandler(zoomRW(_.allStaffShifts)((m, v) => m.copy(allStaffShifts = v))),
      ...
      new StaffShiftHandler(zoomRW(_.staffShifts)((m, v) => m.copy(staffShifts = v))),
    )
    composedHandlers
  }
}
