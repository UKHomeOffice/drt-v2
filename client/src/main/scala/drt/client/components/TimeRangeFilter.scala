...
case class CustomWindowHHMM(start: String, end: String) extends TimeRangeHoursMM {
...
case class WholeDayWindowHHMM() extends TimeRangeHoursMM {
...
case class CurrentWindowHHMM() extends TimeRangeHoursMM {
...
object TimeRangeHoursMM {
  def apply(start: String, end: String): CustomWindowHHMM = {
    CustomWindowHHMM(start, end)
  }
}
