...
import io.kinoplan.scalajs.react.material.ui.core.{AutocompleteRenderInputParams, MuiAutocomplete, MuiAutocompleteOption, MuiTextField}
  ...
  def apply(shortLabel: Boolean = false,
    ...
    .render_P { props =>
      ...
      if (sortedFlights.nonEmpty) {
        ...
        val acTextInput: js.Function1[AutocompleteRenderInputParams, Node] = (params: AutocompleteRenderInputParams) => MuiTextField(
          id = params.id,
