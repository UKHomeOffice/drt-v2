...
class StaffMovementsActorBase(val now: () => SDateLike,
  ...
  def receiveCommand: Receive = {
    ...
    case AddStaffMovements(movementsToAdd) =>
      ...
      persistAndMaybeSnapshotWithAck(messagesToPersist, sender(), AddStaffMovementsAck(movementsToAdd))
    ...
    case RemoveStaffMovements(uuidToRemove) =>
      ...
      persistAndMaybeSnapshotWithAck(messagesToPersist, sender(), RemoveStaffMovementsAck(uuidToRemove))
