...
import controllers.{FeatureGuideProviderLike, SeminarProviderLike, UserRoleProviderLike}
...
trait DrtSystemInterface extends UserRoleProviderLike with FeatureGuideProviderLike with SeminarProviderLike {
