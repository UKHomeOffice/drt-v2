...
//                           updateStaffMinutesFn: CrunchMinutesMigrationUpdate,
  ...
  val minutesMigrationActor: ActorRef = system.actorOf(MinutesMigrationActor.props(journalType, minutesRouterMigrationActor, legacyPersistenceId), s"MinutesMigrationActor$legacyPersistenceId")
