...
import drt.shared.api.ArrivalSuffix
...
class FlightCodeSpec extends CrunchTestLike {
  "Can parse an IATA to carrier code and voyage number" >> {
    ...
    flightCodeToParts("FR836F") === ((CarrierCode("FR"), VoyageNumber("836"), Option(ArrivalSuffix("F"))))
    flightCodeToParts("U2836F") === ((CarrierCode("U2"), VoyageNumber("836"), Option(ArrivalSuffix("F"))))
    flightCodeToParts("0B836F") === ((CarrierCode("0B"), VoyageNumber("836"), Option(ArrivalSuffix("F"))))
  }
  ...
  "Can parse an ICAO to carrier code and voyage number" >> {
    ...
    flightCodeToParts("RYR836F") === ((CarrierCode("RYR"), VoyageNumber("836"), Option(ArrivalSuffix("F"))))
  }
