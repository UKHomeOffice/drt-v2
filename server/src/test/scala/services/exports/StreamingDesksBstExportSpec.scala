...
class StreamingDesksBstExportSpec extends CrunchTestLike {
  ...
  "When exporting DeskRecs during BST" >> {
    ...
    "Given an export spanning 1 local date, I should get back the desk recs for that time period" >> {
      ...
      val expected =
        s"""|2021-04-06,T1,00:00,17,8,5,12,11,17,8,4,12,11,17,8,3,12,11,2,1,1,14
            |2021-04-06,T1,00:15,17,8,5,12,11,17,8,4,12,11,17,8,3,12,11,2,1,1,14
            |2021-04-06,T1,00:30,17,8,5,12,11,17,8,4,12,11,17,8,3,12,11,2,1,1,14
            |2021-04-06,T1,00:45,17,8,5,12,11,17,8,4,12,11,17,8,3,12,11,2,1,1,14
            |2021-04-06,T1,01:00,16,8,5,12,11,16,8,4,12,11,16,8,3,12,11,2,1,1,14
            |2021-04-06,T1,01:15,16,8,5,12,11,16,8,4,12,11,16,8,3,12,11,2,1,1,14
