    ...
    "Then we should see that represented by 2 CSV rows" >> {
      ...
      val movements = List(
        StaffMovement(
          Terminal("T1"),
          "test",
          SDate("2020-07-07T12:00:00Z").millisSinceEpoch,
          2,
          uuid,
          None,
        ...
        StaffMovement(
          Terminal("T1"),
          "test",
          SDate("2020-07-07T13:00:00Z").millisSinceEpoch,
          -2,
          uuid,
          None,
          Option("test@test.com")
    ...
    "Then we should see that represented by 4 CSV rows" >> {
      ...
      val movements = List(
        ...
        StaffMovement(
          Terminal("T1"),
          "test2",
          SDate("2020-07-07T12:15:00Z").millisSinceEpoch,
          4,
          uuid2,
          None,
          Option("test@test.com")
        ...
        StaffMovement(
          Terminal("T1"),
          "test2",
          SDate("2020-07-07T16:00:00Z").millisSinceEpoch,
          -4,
          uuid2,
          None,
          Option("test@test.com")
