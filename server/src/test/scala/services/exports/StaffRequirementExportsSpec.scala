...
class StaffRequirementExportsSpec extends Specification {
  "groupByXMinutes" should {
    "group a list of minutes into groups of 15 minutes" in {
      val start = SDate("2023-09-26T00:00", Crunch.europeLondonTimeZone)
      ...
      val expected = Map(
        0 -> fifteenMins(SDate("2023-09-26T00:00", Crunch.europeLondonTimeZone)),
        1 -> fifteenMins(SDate("2023-09-26T00:15", Crunch.europeLondonTimeZone)),
        2 -> fifteenMins(SDate("2023-09-26T00:30", Crunch.europeLondonTimeZone)),
        3 -> fifteenMins(SDate("2023-09-26T00:45", Crunch.europeLondonTimeZone))
      )
      grouped === expected
    }
  }
  ...
  "toHourlyStaffing" should {
    "return the available, required & diff columns for the specified slot sizes" in {
      val staff = Seq(
        StaffMinute(T1, SDate("2023-09-26T00:00", Crunch.europeLondonTimeZone).millisSinceEpoch, 15, 2, 0, None),
        StaffMinute(T1, SDate("2023-09-26T00:01", Crunch.europeLondonTimeZone).millisSinceEpoch, 16, 3, 0, None),
        StaffMinute(T1, SDate("2023-09-26T12:15", Crunch.europeLondonTimeZone).millisSinceEpoch, 11, 2, 0, None),
        StaffMinute(T1, SDate("2023-09-26T12:17", Crunch.europeLondonTimeZone).millisSinceEpoch, 10, 4, 0, None),
      )
      val crunch = Seq(
        CrunchMinute(T1, EeaDesk, SDate("2023-09-26T00:00", Crunch.europeLondonTimeZone).millisSinceEpoch, 0d, 0d, 10, 0, None, None, None, None, None, None, None),
        CrunchMinute(T1, EeaDesk, SDate("2023-09-26T00:01", Crunch.europeLondonTimeZone).millisSinceEpoch, 0d, 0d, 11, 0, None, None, None, None, None, None, None),
        CrunchMinute(T1, EeaDesk, SDate("2023-09-26T12:15", Crunch.europeLondonTimeZone).millisSinceEpoch, 0d, 0d, 12, 0, None, None, None, None, None, None, None),
        CrunchMinute(T1, EeaDesk, SDate("2023-09-26T12:17", Crunch.europeLondonTimeZone).millisSinceEpoch, 0d, 0d, 13, 0, None, None, None, None, None, None, None),
      )
