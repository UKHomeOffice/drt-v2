  ...
  "apiFlightToFlightMessage" should {
    ...
    "take a single v1 FlightMessage and return an Arrival representing it" in {
      val flightMessage = FlightMessage(
        operator = Some("Op"),
        schDTOLD = Some("2016-01-01T13:00:00Z"),
        actDTOLD = Some("2016-01-01T13:10:00Z"),
        estDTOLD = Some("2016-01-01T13:05:00Z"),
        estChoxDTOLD = Some("2016-01-01T13:15:00Z"),
        actChoxDTOLD = Some("2016-01-01T13:20:00Z"),
        gate = Some("10"),
        stand = Some("10A"),
        status = Some("scheduled"),
        maxPax = Some(200),
