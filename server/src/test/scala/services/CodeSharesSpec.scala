...
class CodeSharesSpec extends Specification {
  ...
  "Given one flight " +
    ...
    val flight = ApiFlightWithSplits(arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", totalPax = Option(100), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
  ...
  "Given two flights which are codeshares of each other " +
    ...
    val flight1 = ApiFlightWithSplits(arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", totalPax = Option(100), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
    val flight2 = ApiFlightWithSplits(arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", totalPax = Option(150), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
  ...
  "Given three flights which are codeshares of each other " +
    ...
    val flight1 = ApiFlightWithSplits(arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", totalPax = Option(100), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
    val flight2 = ApiFlightWithSplits(arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", totalPax = Option(150), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
    val flight3 = ApiFlightWithSplits(arrival(iata = "ZZ5566", schDt = "2016-01-01T10:25Z", totalPax = Option(175), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
  ...
  "Given 3 flight, where there is a set of code shares and one unique flight " +
    ...
    val flightCS1a = ApiFlightWithSplits(arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", totalPax = Option(100), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
    val flightCS1b = ApiFlightWithSplits(arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", totalPax = Option(150), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
    val flight = ApiFlightWithSplits(arrival(iata = "KL1010", schDt = "2016-01-01T10:25Z", totalPax = Option(175), terminal = T2, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
  ...
  "Given two flights with the same scheduled time, the same terminal, but different origins " +
    ...
    val flight1 = ApiFlightWithSplits(arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", totalPax = Option(100), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
    val flight2 = ApiFlightWithSplits(arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", totalPax = Option(150), terminal = T1, origin = PortCode("CDG")).toArrival(LiveFeedSource), Set())
  ...
  "Given two flights with the same scheduled time, the same origins, but different terminals " +
    ...
    "Then we should see two tuples, each with one of the flights and no code shares" >> {
    val flight1 = ApiFlightWithSplits(arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", totalPax = Option(100), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
    val flight2 = ApiFlightWithSplits(arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", totalPax = Option(150), terminal = T2, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
  ...
  "Given two flights with the same origins, the same different terminals, but different scheduled times" +
    "When we ask for unique flights " +
    "Then we should see two tuples, each with one of the flights and no code shares" >> {
    val flight1 = ApiFlightWithSplits(arrival(iata = "BA0001", schDt = "2016-01-01T10:30Z", totalPax = Option(100), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
    val flight2 = ApiFlightWithSplits(arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", totalPax = Option(150), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
  ...
  "Given two code-share flights where one has a higher number of passengers but no live API data, and the other does has live API data" should {
    "The main flight should be the one with the live API data" in {
      ...
      val flight1 = ApiFlightWithSplits(arrival(iata = "BA0001", schDt = "2016-01-01T10:30Z", totalPax = Option(100), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set(apiSplits))
      val flight2 = ApiFlightWithSplits(arrival(iata = "AA8778", schDt = "2016-01-01T10:30Z", totalPax = Option(150), terminal = T1, origin = PortCode("JFK")).toArrival(LiveFeedSource), Set())
