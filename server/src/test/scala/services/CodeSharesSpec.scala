...
class CodeSharesSpec extends Specification {
  ...
  "Given one flight " +
    ...
    val flight: Arrival = arrival(flightId = Option(1), iata = "BA0001", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(100))
  ...
  "Given two flights which are codeshares of each other " +
    ...
    val flight1: Arrival = arrival(flightId = Option(1), iata = "BA0001", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(100))
    val flight2: Arrival = arrival(flightId = Option(2), iata = "AA8778", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(150))
  ...
  "Given three flights which are codeshares of each other " +
    ...
    val flight1: Arrival = arrival(flightId = Option(1), iata = "BA0001", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(100))
    val flight2: Arrival = arrival(flightId = Option(2), iata = "AA8778", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(150))
    val flight3: Arrival = arrival(flightId = Option(3), iata = "ZZ5566", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(175))
  ...
  "Given 5 flight, where there are 2 sets of code shares and one unique flight " +
    ...
    val flightCS1a: Arrival = arrival(flightId = Option(1), iata = "BA0001", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(100))
    val flightCS1b: Arrival = arrival(flightId = Option(2), iata = "AA8778", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(150))
    val flightCS2a: Arrival = arrival(flightId = Option(3), iata = "ZZ5566", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "CDG", actPax = Option(55))
    val flightCS2b: Arrival = arrival(flightId = Option(4), iata = "TG8000", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "CDG", actPax = Option(180))
    val flight: Arrival = arrival(flightId = Option(5), iata = "KL1010", schDt = "2016-01-01T10:25Z", terminal = "T2", origin = "JFK", actPax = Option(175))
  ...
  "Given two flights with the same scheduled time, the same terminal, but different origins " +
    ...
    val flight1: Arrival = arrival(flightId = Option(1), iata = "BA0001", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(100))
    val flight2: Arrival = arrival(flightId = Option(2), iata = "AA8778", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "CDG", actPax = Option(150))
  ...
  "Given two flights with the same scheduled time, the same origins, but different terminals " +
    ...
    "Then we should see two tuples, each with one of the flights and no code shares" >> {
    val flight1: Arrival = arrival(flightId = Option(1), iata = "BA0001", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(100))
    val flight2: Arrival = arrival(flightId = Option(2), iata = "AA8778", schDt = "2016-01-01T10:25Z", terminal = "T2", origin = "JFK", actPax = Option(150))
  ...
  "Given two flights with the same origins, the same different terminals, but different scheduled times" +
    "When we ask for unique flights " +
    "Then we should see two tuples, each with one of the flights and no code shares" >> {
    val flight1: Arrival = arrival(flightId = Option(1), iata = "BA0001", schDt = "2016-01-01T10:30Z", terminal = "T1", origin = "JFK", actPax = Option(100))
    val flight2: Arrival = arrival(flightId = Option(2), iata = "AA8778", schDt = "2016-01-01T10:25Z", terminal = "T1", origin = "JFK", actPax = Option(150))
