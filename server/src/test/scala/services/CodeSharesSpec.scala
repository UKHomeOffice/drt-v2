...
class CodeSharesSpec extends Specification {
  ...
  "Given one flight " +
    ...
    val flight: Arrival = arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", actPax = Option(100), terminal = T1, origin = PortCode("JFK"))
  ...
  "Given two flights which are codeshares of each other " +
    ...
    val flight1: Arrival = arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", actPax = Option(100), terminal = T1, origin = PortCode("JFK"))
    val flight2: Arrival = arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", actPax = Option(150), terminal = T1, origin = PortCode("JFK"))
  ...
  "Given three flights which are codeshares of each other " +
    ...
    val flight1: Arrival = arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", actPax = Option(100), terminal = T1, origin = PortCode("JFK"))
    val flight2: Arrival = arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", actPax = Option(150), terminal = T1, origin = PortCode("JFK"))
    val flight3: Arrival = arrival(iata = "ZZ5566", schDt = "2016-01-01T10:25Z", actPax = Option(175), terminal = T1, origin = PortCode("JFK"))
  ...
  "Given 5 flight, where there are 2 sets of code shares and one unique flight " +
    ...
    val flightCS1a: Arrival = arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", actPax = Option(100), terminal = T1, origin = PortCode("JFK"))
    val flightCS1b: Arrival = arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", actPax = Option(150), terminal = T1, origin = PortCode("JFK"))
    val flightCS2a: Arrival = arrival(iata = "ZZ5566", schDt = "2016-01-01T10:25Z", actPax = Option(55), terminal = T1, origin = PortCode("CDG"))
    val flightCS2b: Arrival = arrival(iata = "TG8000", schDt = "2016-01-01T10:25Z", actPax = Option(180), terminal = T1, origin = PortCode("CDG"))
    val flight: Arrival = arrival(iata = "KL1010", schDt = "2016-01-01T10:25Z", actPax = Option(175), terminal = T2, origin = PortCode("JFK"))
  ...
  "Given two flights with the same scheduled time, the same terminal, but different origins " +
    ...
    val flight1: Arrival = arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", actPax = Option(100), terminal = T1, origin = PortCode("JFK"))
    val flight2: Arrival = arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", actPax = Option(150), terminal = T1, origin = PortCode("CDG"))
  ...
  "Given two flights with the same scheduled time, the same origins, but different terminals " +
    ...
    "Then we should see two tuples, each with one of the flights and no code shares" >> {
    val flight1: Arrival = arrival(iata = "BA0001", schDt = "2016-01-01T10:25Z", actPax = Option(100), terminal = T1, origin = PortCode("JFK"))
    val flight2: Arrival = arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", actPax = Option(150), terminal = T2, origin = PortCode("JFK"))
  ...
  "Given two flights with the same origins, the same different terminals, but different scheduled times" +
    "When we ask for unique flights " +
    "Then we should see two tuples, each with one of the flights and no code shares" >> {
    val flight1: Arrival = arrival(iata = "BA0001", schDt = "2016-01-01T10:30Z", actPax = Option(100), terminal = T1, origin = PortCode("JFK"))
    val flight2: Arrival = arrival(iata = "AA8778", schDt = "2016-01-01T10:25Z", actPax = Option(150), terminal = T1, origin = PortCode("JFK"))
