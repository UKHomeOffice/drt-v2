...
class EdiFlightAdjustmentsSpec extends Specification {
  val arrival1BaggageAtA1: LiveArrival = ArrivalGenerator.live(
    iata = "TST100",
    terminal = Terminal("A1"),
    schDt = "2020-07-17T14:00Z",
    baggageReclaimId = Option("1")
  )
  val arrival2BaggageAtA1: LiveArrival = ArrivalGenerator.live(
    iata = "TST100",
    terminal = Terminal("A1"),
    schDt = "2020-07-17T14:00Z",
    baggageReclaimId = Option("2")
  )
  val arrival3BaggageAtA1: LiveArrival = ArrivalGenerator.live(
    iata = "TST100",
    terminal = Terminal("A1"),
    schDt = "2020-07-17T14:00Z",
    baggageReclaimId = Option("3")
  )

  val arrival1BaggageAtA2: LiveArrival = ArrivalGenerator.live(
    iata = "TST100",
    terminal = Terminal("A1"),
    schDt = "2020-07-17T14:00Z",
    baggageReclaimId = Option("7")
  )
  val arrival2BaggageAtA2: LiveArrival = ArrivalGenerator.live(
    iata = "TST100",
    terminal = Terminal("A1"),
    schDt = "2020-07-17T14:00Z",
    baggageReclaimId = Option("8")
  )

  val arrivalAtA1: LiveArrival =
    ArrivalGenerator.live(iata = "TST100", terminal = Terminal("A1"), schDt = "2020-07-17T14:00Z")
  val arrival2AtA1: LiveArrival =
    ArrivalGenerator.live(iata = "TST200", terminal = Terminal("A1"), schDt = "2020-07-17T15:00Z")
