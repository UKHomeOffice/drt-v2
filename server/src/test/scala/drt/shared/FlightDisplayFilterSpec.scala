...
class FlightDisplayFilterSpec extends Specification {
  ...
  "Given flights for LHR spanning all terminals arriving before T4 starts handling red list flights" >> {
    ...
    "When I ask for T2 display flights, I should get only T2 flights" >> {
      coachWalkTime.flightFilterForTerminal(flightsPreT4Opening, T2, isRedListOrigin) === List(redListT2preT4, nonRedListT2preT4)
    }
    "When I ask for T3 display flights, I should get all the T3 flights, plus any T2 & T5 red list origin flights" >> {
      coachWalkTime.flightFilterForTerminal(flightsPreT4Opening, T3, isRedListOrigin) === List(redListT2preT4, redListT3preT4, nonRedListT3preT4, redListT5preT4)
    }
    "When I ask for T4 display flights, I should get only T4 flights" >> {
      coachWalkTime.flightFilterForTerminal(flightsPreT4Opening, T4, isRedListOrigin) === List(redListT4preT4, nonRedListT4preT4)
    }
    "When I ask for T5 display flights, I should get only T5 flights" >> {
      coachWalkTime.flightFilterForTerminal(flightsPreT4Opening, T5, isRedListOrigin) === List(redListT5preT4, nonRedListT5preT4)
    }
  }
  ...
  "Given flights for LHR spanning all terminals arriving after T4 starts handling red list flights" >> {
    ...
    "When I ask for T2 display flights, I should get only T2 flights" >> {
      coachWalkTime.flightFilterForTerminal(flightsPostT4Opening, T2, isRedListOrigin) === List(redListT2postT4, nonRedListT2postT4)
    }
    "When I ask for T3 display flights, I should get only T3 flights" >> {
      coachWalkTime.flightFilterForTerminal(flightsPostT4Opening, T3, isRedListOrigin) === List(redListT3postT4, nonRedListT3postT4)
    }
    "When I ask for T4 display flights, I should get all the T4 flights, plus any T2 , T3 & T5 red list origin flights" >> {
      coachWalkTime.flightFilterForTerminal(flightsPostT4Opening, T4, isRedListOrigin) === List(redListT2postT4, redListT3postT4, redListT4postT4, nonRedListT4postT4, redListT5postT4)
    }
    "When I ask for T5 display flights, I should get only T5 flights" >> {
      coachWalkTime.flightFilterForTerminal(flightsPostT4Opening, T5, isRedListOrigin) === List(redListT5postT4, nonRedListT5postT4)
    }
  }
}
