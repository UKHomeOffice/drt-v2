...
class ArrivalsActorSpec extends Specification {
  val arrival1: Arrival = ArrivalGenerator
    .arrival(iata = "BA0001", terminal = T1, origin = PortCode("JFK"), schDt = "2019-01-01T00:05", totalPax = Option(100)).toArrival(AclFeedSource)
  val arrival2: Arrival = ArrivalGenerator
    .arrival(iata = "BA0002", terminal = T1, origin = PortCode("ABC"), schDt = "2019-01-01T00:35", totalPax = Option(200)).toArrival(AclFeedSource)
  val arrival3: Arrival = ArrivalGenerator
    .arrival(iata = "BA0003", terminal = T1, origin = PortCode("ZZZ"), schDt = "2019-01-01T00:55", totalPax = Option(250)).toArrival(AclFeedSource)
