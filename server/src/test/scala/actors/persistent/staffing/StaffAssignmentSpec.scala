...
class StaffAssignmentSpec extends Specification {
  ...
  "StaffAssignment" should {
    "split into slots" in {
      val staffAssignment = StaffAssignment(
        "afternoon",
        Terminal("terminal"),
        SDate(2023, 10, 1, 14, 0).millisSinceEpoch,
        SDate(2023, 10, 1, 15, 0).millisSinceEpoch,
        0,
        None
      )
      ...
      val expected = Seq(
        StaffAssignment(
          ...
          Terminal("T1"),
          SDate(2023, 10, 1, 15, 0).millisSinceEpoch,
          SDate(2023, 10, 1, 15, 14).millisSinceEpoch,
          5,
          None
        ),
        StaffAssignment(
          "day",
          Terminal("T1"),
          SDate(2023, 10, 1, 15, 15).millisSinceEpoch,
          SDate(2023, 10, 1, 15, 29).millisSinceEpoch,
          5,
          None
        ),
        StaffAssignment(
          "day",
          Terminal("T1"),
          SDate(2023, 10, 1, 15, 30).millisSinceEpoch,
          SDate(2023, 10, 1, 15, 44).millisSinceEpoch,
          5,
          None
        ),
        StaffAssignment(
          "day",
          Terminal("T1"),
          SDate(2023, 10, 1, 15, 45).millisSinceEpoch,
          SDate(2023, 10, 1, 15, 59).millisSinceEpoch,
          5,
          None
        )
      )
