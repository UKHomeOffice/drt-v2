...
//    skipped("Exploratory test - requires VPN connection, correct feed url and username env vars")
    ...
    val endpoint = "https://webservice.cwl.aero/AIDXReadFlight/SERVICES/RequestFlightService.svc" //sys.env("BHX_IATA_ENDPOINT_URL")
    val username = "BORDERFORCE" //sys.env("BHX_IATA_USERNAME")
