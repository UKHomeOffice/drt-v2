error id: file://<WORKSPACE>/client/src/main/scala/drt/client/components/StaffingUtil.scala:
file://<WORKSPACE>/client/src/main/scala/drt/client/components/StaffingUtil.scala
...
offset: 128
uri: file://<WORKSPACE>/client/src/main/scala/drt/client/components/StaffingUtil.scala
text:
```scala
...
o@@bject StaffingUtil {
  def navigationDates(viewingDate: SDateLike, dayRangeType: String, now: () => SDateLike): (SDateLike, SDateLike) = {
