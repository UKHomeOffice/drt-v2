error id: file://<WORKSPACE>/server/src/main/scala/actors/persistent/staffing/StaffingUtil.scala:
file://<WORKSPACE>/server/src/main/scala/actors/persistent/staffing/StaffingUtil.scala
...
offset: 2181
uri: file://<WORKSPACE>/server/src/main/scala/actors/persistent/staffing/StaffingUtil.scala
text:
```scala
...
object StaffingUtil {
  ...
  def updateWithAShiftDefaultStaff(previousShift: Shift, overridingShift: Seq[StaffShiftRow], shift: Shift, allShifts: ShiftAssignments): Seq[StaffAssignmentLike] = {
    ...
    println(s"...previou@@sShift :${previousShift}  shift :$shift")
