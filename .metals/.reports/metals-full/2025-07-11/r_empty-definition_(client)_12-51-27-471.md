error id: file://<WORKSPACE>/client/src/main/scala/drt/client/services/handlers/ShiftsHandler.scala:SetAllShiftAssignments
file://<WORKSPACE>/client/src/main/scala/drt/client/services/handlers/ShiftsHandler.scala
empty definition using pc, found symbol in pc: 
semanticdb not found

found definition using fallback; symbol SetAllShiftAssignments
offset: 5335
uri: file://<WORKSPACE>/client/src/main/scala/drt/client/services/handlers/ShiftsHandler.scala
text:
```scala
      ...
      shift match {
        case Some(s) =>
          val apiCallEffect = Effect(DrtApi.post("shifts/update", write(s))
            .map(r => SetAllShif@@tAssignments(read[ShiftAssignments](r.responseText)))
            .recoverWith {
              case t =>
