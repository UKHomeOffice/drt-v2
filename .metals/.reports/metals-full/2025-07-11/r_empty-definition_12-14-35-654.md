error id: file://<WORKSPACE>/server/src/test/scala/controllers/application/ShiftsControllerSpec.scala:
...
case class MockShiftsService() extends uk.gov.homeoffice.drt.service.staffing.ShiftsService {
  ...
  override def saveShift(shift: Shift): Future[Boolean] = 
    Future.successful(shifts :+= shift; true)
