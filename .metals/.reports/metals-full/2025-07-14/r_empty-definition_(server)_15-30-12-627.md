error id: file://<WORKSPACE>/server/src/main/scala/controllers/application/ShiftsController.scala:uk/gov/homeoffice/drt/service/staffing/ShiftsService#getShift().
file://<WORKSPACE>/server/src/main/scala/controllers/application/ShiftsController.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol uk/gov/homeoffice/drt/service/staffing/ShiftsService#getShift().
...
//        Future.successful(Ok("shift received: " + shift.toString))
        ctrl.shiftsService.get@@Shift(shift.port, shift.terminal, shift.shiftName, convertToSqlDate(shift.startDate)).flatMap {
