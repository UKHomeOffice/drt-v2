error id: file://<WORKSPACE>/server/src/main/scala/controllers/application/ShiftsController.scala:uk/gov/homeoffice/drt/service/staffing/ShiftAssignmentsService#updateShiftAssignments().
file://<WORKSPACE>/server/src/main/scala/controllers/application/ShiftsController.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol uk/gov/homeoffice/drt/service/staffing/ShiftAssignmentsService#updateShiftAssignments().
...
//        Future.successful(Ok("shift received: " + shift.toString))
        ctrl.shiftsService.getShifts(shift.port, shift.terminal, shift.shiftName, convertToSqlDate(shift.startDate)).flatMap {
          case Some(previousShift) =>
            ...
            ctrl.shiftsService.updateShift(previousShift, shift).flatMap { _ =>
              shiftAssignmentsService.allShiftAssignments.flatMap { allShiftAssignments =>
                ...
                shiftAssignmentsService.updateS@@hiftAssignments(updatedAssignments)
                }
              }.recoverWith {
                case e: Exception => Future.successful(BadRequest(s"Failed to update shifts: ${e.getMessage}"))
              }
