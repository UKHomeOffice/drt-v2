error id: file://<WORKSPACE>/server/src/main/scala/controllers/application/ShiftsController.scala:uk/gov/homeoffice/drt/service/staffing/ShiftUtil.toStaffShiftRow().
file://<WORKSPACE>/server/src/main/scala/controllers/application/ShiftsController.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol uk/gov/homeoffice/drt/service/staffing/ShiftUtil.toStaffShiftRow().
          ...
          case Some(previousShift) =>
            ...
            ctrl.shiftsService.updateShift(previousShift, shift).flatMap { _ =>
              shiftAssignmentsService.allShiftAssignments.flatMap { allShiftAssignments =>
                 ...
                 toStaffShift@@Row(shift, None, None, new java.sql.Timestamp(System.currentTimeMillis())))
